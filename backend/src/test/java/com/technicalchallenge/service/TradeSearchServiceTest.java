...
public class TradeSearchServiceTest {
        ...
        void setUp() {
                ...
                tradeSearchValidator = new TradeSearchValidator();
        ...
        void testGetTradesByBook_Success() {
                ...
                SearchTradeByCriteria bookSearch = new SearchTradeByCriteria("TestBookC", null, null, null, null, null,
                                null,
                                null, null);
        ...
        void testGetTradesByMultipleCriteria_Success() {
                ...
                SearchTradeByCriteria criteriaSearch = new SearchTradeByCriteria("TestBookA", "TestCounterpartyA",
                                "John", null,
                                null, null, null,
                                null, null);
                ...
                assertTrue(result.stream()
                                .allMatch(t -> t.getBook().getBookName().equals("TestBookA") && t.getCounterparty()
                                                .getName().equals("TestCounterpartyA")
                                                && t.getTraderUser().getFirstName().equals("John")));
                verify(tradeRepository, times(1)).findAll(ArgumentMatchers.<Specification<Trade>>any());
        ...
        void testGetTradesByInvalidDateRange_ShouldFail() {
                ...
                InvalidSearchException invalidSearchCriteriaException = assertThrows(
                                ...
                                () -> {
                                        tradeSearchValidator.validateSearch(criteriaSearch);
                                });

                // Then - Verifies the exception was thrown.
                assertEquals(errorMessage, invalidSearchCriteriaException.getMessage());
        ...
        void testGetTradesByRSQL_MissingQuery() {
                ...
                String errorMessage = "Query must not be null or empty";
                ...
                // Then - Verifies the exception was thrown.
                assertEquals(errorMessage, invalidSearchException.getMessage());
        }
